...
- [Create Custom Agents Instructions Promptfile](.github/prompts/create-custom-agents-instructions.instructions.prompt.md) - Generates an instruction file for creating and reviewing GitHub Copilot custom agents with repository-specific conventions and provenance requirements. Provenance: [conversation log](ai-logs/2026/04/08/create-custom-agents-instructions-promptfile-20260408/conversation.md)
